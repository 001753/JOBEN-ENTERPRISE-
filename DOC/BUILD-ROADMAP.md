...
**Versi roadmap:** 3.0 — PRD 5.3 global-ready phase contract  
...
7. Region/market policy, billing, AI, growth, dan ekspansi provider.
...
| 3 | Global expansion readiness | S5 / Gate E | Market-pack/region baru yang terverifikasi |
| 4 | ISO 27001 | Governance expansion | Framework dan mapping ISO yang terverifikasi |
| 5 | GDPR/CCPA | Privacy expansion | Data map dan workflow privacy yang dapat diaudit |
| 6 | Questionnaire AI | S6 / AI gate | AI retrieval/citation dengan human approval |
| 7 | PCI SAQ assistant | Product expansion | Wizard SAQ, bukan ASV scanning |
| 8 | White-label & auditor marketplace | Commercial expansion | Agency multi-tenant dengan batas tanggung jawab jelas |
| 9 | Hardening & GA | S7 / Gate D | Release produksi dengan SLO, recovery, legal, dan on-call |

Phase 0 sampai 1B adalah jalur MVP live. Phase 2–8 adalah ekspansi setelah
vertical slice terbukti. Phase 9 bukan “tambahan kosmetik”; GA tidak boleh
...
| P3 | Gate C, market-pack RFC, provider/residency facts, Gate E reviewer | Global-ready market/region expansion yang scoped dan terverifikasi | market baru live hanya karena UI translated |
| P4 | Gate E, official ISO source, mapping owner | ISO framework/mapping/checks yang verified per capability | ISO certification/attestation |
| P5 | Gate E, privacy source and residency facts | Privacy operations yang auditable dan policy-bound | legal conclusion atau unverified residency claim |
| P6 | Stable M-05/M-06, AI safety RFC and golden set | AI questionnaire/assistant dengan citation dan human approval | AI-written compliance truth |
| P7 | M-05/M-06, PCI scope source, human-review workflow | SAQ readiness assistant | ASV scanning, certification, normative auto-approval |
| P8 | M-01/M-12/M-13, delegated-access RFC | Agency and auditor marketplace boundaries | delegated write access to compliance truth |
| P9 | All claimed live capabilities, incident/restore/pentest evidence | GA release with SLO, recovery, legal, on-call | release with expired proof or unresolved critical truth/security risk |
...
- Pecah PRD menjadi `CapabilityRecord` per modul, check, connector, report,
  dan AI feature.
- Tetapkan global-ready core sejak awal: `homeRegion`, data-residency policy,
  locale, timezone, currency, tax profile, provider registry, capability
  registry, versioning, dan market-pack boundary.
...
- Pastikan deployment boundary MVP Indonesia/Asia, object storage, backup,
  logging, subprocessors, dan cross-region transfer policy memiliki owner serta
  tidak memiliki fallback region diam-diam.
...
- Catalog version, Xendit sandbox checkout, signed webhook inbox, subscription
  ...
  reconciliation.
- MVP market-pack Indonesia/Asia: catalog IDR dalam minor unit, payment routing,
  invoice/tax policy, notification channel, locale, data-residency limitation,
  provider/capability registry, dan customer-facing regional copy.
...
# PHASE 3 — Global expansion readiness

**Target PRD:** setelah MVP regional, sebelum governance expansion  
**Slice:** S5 Regional/market expansion  
**Prioritas:** P1 — global-ready core dan market-pack verification  
**Exit:** Gate E lulus

## 3.1 Market-pack contract

- Definisikan market-pack versioned dengan owner, target region, legal basis,
  supported locale, timezone, currency ISO 4217/minor unit, tax/invoice policy,
  pricing/catalog, notification channels, support model, dan customer limitation.
- Gunakan provider adapter/registry dan capability registry; market baru tidak
  boleh menambahkan provider atau capability melalui hardcode pada domain core.
- Tetapkan feature/capability availability per region dan customer-facing copy
  yang menjelaskan status `planned`, `verification_required`, `degraded`, atau
  `live_verified`.

## 3.2 Region, provider, dan residency verification

- Verifikasi provider sandbox, endpoint/permission contract, rate limit, schema
  drift, fixture, deprecation, proof record, expiry, dan rollback untuk setiap
  market/region yang diusulkan.
- Verifikasi `homeRegion`, data-residency policy, object storage, backup, log,
  AI, subprocessors, deletion, legal hold, dan cross-region transfer controls.
- Uji cross-region isolation, signed access, support access, failure routing,
  dan pastikan tidak ada fallback region diam-diam untuk data restricted.

## 3.3 Expansion operations dan Gate E

- Siapkan billing routing dan reconciliation, locale completeness, support/SLO,
  status communication, incident runbook, cost ceiling, dan independent reviewer.
- Setiap target market memiliki proof packet terpisah; bukti demo, translated UI,
  atau provider yang belum diverifikasi tidak dapat menaikkan capability status.

**Gate E — stop/go wajib lulus:**

- Provider/framework contract dan sandbox comparison tersedia.
- Residency, transfer, backup, logging, AI, subprocessors, deletion, dan legal
  policy diverifikasi terhadap region/provider nyata.
- Locale 100% lengkap, pricing/currency/tax dan billing reconciliation lulus.
- Support serta incident runbook aktif, cross-region isolation test lulus, dan
  reviewer independen menyetujui proof record beserta expiry/reverification.

**Jika gagal:** market-pack tetap `verification_required`; jangan mempublikasikan
market baru, mengaktifkan checkout, atau menyatakan residency/compliance claim.

---

# PHASE 4 — ISO 27001

**Target PRD:** setelah Gate E dan region expansion readiness
**Prioritas:** P1 — framework expansion

## 4.1 Framework and mapping
...
# PHASE 5 — GDPR/CCPA privacy operations

**Target PRD:** setelah Phase 4 dan privacy/regional readiness
...
## 5.2 DSAR and privacy workflows
...
# PHASE 6 — Questionnaire AI

**Target PRD:** setelah Phase 5 dan evidence system stabil
**Prioritas:** P1 — hanya setelah evidence system stabil

## 6.1 AI gateway safety
...
## 6.3 Evaluator and cost controls
...
# PHASE 7 — PCI SAQ assistant

**Target PRD:** setelah Phase 6 dan PCI scope source terverifikasi
...
# PHASE 8 — White-label & auditor marketplace

**Target PRD:** setelah Gate E dan delegated-access readiness
**Prioritas:** P2 — scale/commercial

## 8.1 Agency multi-tenant
...
# PHASE 9 — Hardening & General Availability

**Target PRD:** setelah seluruh target release gate
**Prioritas:** P0 untuk GA
**Slice:** S7 Operational readiness  
**Exit:** Gate D lulus

## 9.1 Security and privacy hardening
...
|---|---|---|---|---|
| §0 | Anti-false-data, definition of truth, demo isolation, perubahan reversible | P0 | P1–P9 untuk capability terdampak | decision log, threat model, live/demo negative test |
| §1 | Sasaran bisnis, sync ≤6 jam, alert <15 menit, single source of truth, batas klaim | P0 | P1–P9 copy dan metric review | product contract, SLO proof, disclaimer review |
...
| §3 | Persona dan OWNER/ADMIN/MEMBER/AUDITOR/GRC access, MFA | P0 | P1–P9 role regression | permission matrix, E2E role test, audit record |
...
| §4.4–4.10 | Full-feature contract, M-01–M-15, dossier, S0–S7, Ready/Done | P0 | P1–P9 per module | module contract, dossier, independent sign-off |
| §5 | Target architecture, stack, hosting prerequisites, external services, RFC rule | P0 | P1B/P3/P9 capacity dan migration review | hosting verification, provider matrix, RFC/rollback |
| §6 | Repository target, scan package, check/capability registry, ModuleContract, status/publication rules | P0 | P1–P9 registry consistency | schemas, registry diff, CI status validation |
| §7 | Scan, cron, idempotency, drift, AWS/GitHub/Google connector/check contracts | P1 | P1B/P3–P4 provider re-verification | sandbox comparison, permission matrix, check dossiers |
| §8 | Finding/control statuses, freshness, coverage, data quality, score/rebuild | P1 | P3–P5 framework regression | deterministic fixtures, rebuild equality, score proof |
| §9 | Evidence lifecycle, redaction, hash/WORM/legal hold, remediation, PDF | P1 | P1B/P2/P5–P6 eligibility review | hash/retention drill, PDF artifact, remediation E2E |
...
| §12 | Tokens, screens, truthful states, accessibility, EN/ID/ZH i18n | P0 | P1–P9 touched screens | visual states, a11y/localization test, locale inventory |
| §13 | AI gateway, routing, scoped retrieval, citation/refusal, approval, public FAQ | P6 | P9 disable/fallback drill | golden set, citation proof, cost log, injection test |
| §14 | IDR catalog, payment boundary, regulation monitor, channels, alert policy | P1B | P2–P5/P9 source/reconciliation review | webhook reconciliation, source hash, delivery evidence |
| §15 | Encryption, secrets, rate limit, audit, backup, residency, deletion, NFR, patch SLA | P0 | P1–P9 security/ops gate | secret/log scan, restore, SLO telemetry, residency decision |
| §16 | Phase 0–9 deliverables dan release gates | P0 | Gate A/B/C/E/D, S4–S7 | signed gate packet and decision |
...
| §18 | Correlation, telemetry, ops dashboard, alerts | P0 | P1–P9 metric/alert review | redacted logs, dashboard, alert timestamps, drills |
...
| §23 | Incident runbooks, restore, quarantine, replay, AI disable, deletion, release discipline | P1B | P2–P9 drills | runbook drill, incident timeline, rollback proof |
| §24 | Definition of Ready/Done, Gate A/B/C/E/D, downgrade on failure | P0 | Applied setiap phase/capability | gate packet dan status transition audit |
...
| Control pack | P0 baseline | P1–P3 expansion | P4–P8 expansion | P9 release proof |
|---|---|---|---|---|
...
| Modul | P0 | P1 | P1B | P2 | P3 | P4 | P5 | P6 | P7 | P8 | P9 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| M-01 Identity/RBAC | foundation | regression | beta roles | auditor roles | region policy | governance | privacy | AI purpose | approval | delegated | hardening |
| M-02 Integration/Credential | contract | AWS | GitHub/ops | eligibility | region/provider | new providers | privacy vendors | document source | PCI scope | agency | rotation/pentest |
| M-03 Scan/Jobs | contract | AWS engine | resilience | drift/source | region routing | expansion | privacy jobs | questionnaire | SAQ jobs | delegated queues | SLO/recovery |
| M-04 Provider Connector | policy | AWS checks | GitHub | SOC2 source | provider registry | six providers | privacy sources | parsers/models | PCI source | marketplace | deprecation |
| M-05 Evidence | data contract | AWS vault | report/restore | publication | residency/transfer | ISO evidence | legal hold | citation | SAQ source | delegated | integrity drill |
| M-06 Finding/Scoring | projection | AWS/SOC2 | beta | eligibility | regional capability | ISO | privacy impact | matching only | readiness only | no truth write | rebuild/load |
| M-07 Remediation/Review | lifecycle | AWS | SLA | policy review | regional review | ISO gap | DSAR/vendor | AI approval | SAQ approval | delegated review | audit/recovery |
| M-08 Dashboard/App | shell/tokens | onboarding | beta/i18n | public/auditor | market-pack UX | frameworks | privacy | questionnaire | SAQ | branding | a11y/locale |
| M-09 Report/Export | contract | boundary | PDF/CSV | auditor | regional invoice/report | ISO | DSAR/DPA | questionnaire | SAQ | branded | artifact/recovery |
| M-10 Notification | event contract | drift | channels/ops | regulation | regional channels | ISO | DSAR/breach | AI notices | reminders | marketplace | SLO/replay |
| M-11 Policy/Risk/Vendor/Reg | contract | SOC2 boundary | regulation ops | monitor/dogfood | region/legal policy | ISO mapping | GDPR/vendor | AI draft | PCI policy | agency policy | governance |
| M-12 Trust/Auditor | eligibility | blocked | prep | full surface | region claims | ISO publish | privacy claims | citation boundary | disclaimer | marketplace | revoke/expiry |
| M-13 Billing/Entitlement | RFC/contract | blocked | sandbox | pricing copy | market routing/reconciliation | plan expansion | privacy data | AI cost | PCI plan | agency billing | reconcile |
| M-14 AI Gateway | safety/RFC | disabled | disabled | public FAQ gate | regional provider policy | summary boundary | draft boundary | questionnaire | SAQ | marketplace copy | disable/fallback |
| M-15 Admin/Ops | foundation | scan/evidence | beta/restore | public/auditor | region operations | governance | privacy | AI cost/safety | SAQ | delegated | full GA |
...
| P3 / S5 / Gate E | §1, §4.1–§5, §10–§15, §17–§24; M-01–M-05, M-08–M-15 regional delta | market-pack contract; region/provider registry; locale/timezone/currency/tax; residency/transfer; backup/log/AI/subprocessor/deletion controls; billing reconciliation; support/runbook | Gate E packet; provider sandbox comparison; residency/transfer evidence; locale completeness; billing reconciliation; cross-region isolation; independent sign-off |
| P4 | §4.2, §7–§12, §14–§15, §17–§20, §24; M-04/M-06/M-07/M-11/M-12 | versioned 93 Annex A; SOC 2↔ISO mapping; gap/readiness workflow; six additional connectors one at a time | official-source provenance; mapping impact/rebuild; per-provider sandbox/permission/schema-drift proof; no unverified status expansion |
| P5 | §4.2, §5, §10–§11, §14–§15, §17–§24; privacy M-05/M-07/M-08/M-09/M-10/M-11/M-15 | PII/data map; cookie scanner; retention/deletion/legal hold/residency; DSAR; approved DPA; breach timer workflow; vendor risk | scoped DSAR/export/delete evidence; legal-hold preservation; residency/vendor verification; source/version audit; breach alert |
| P6 / S6 | §1–§2, §4.2, §6, §9–§11, §13–§15, §17–§18, §23–§24; M-14 | gateway routing/retrieval/redaction; PDF/Excel/CSV questionnaire; citations/refusal; human approval; usage/cost; disable/fallback | golden set; citation quote verification; cross-tenant/injection/stale/legal refusal; `humanApproved`; cost log; provider outage drill |
| P7 | §4.2, §9, §11–§15, §17, §20–§24; PCI M-06–M-09/M-11/M-14/M-15 | SAQ scope wizard; readiness checklist; citations/remediation; review/approval/export; permanent no-ASV boundary | PCI source/version; ambiguity/no-evidence refusal; approval audit; disclaimer review; no certification claim |
| P8 | §3, §4.2, §6, §9–§12, §14–§15, §17–§18, §20, §23–§24; M-01/M-05/M-07–M-13/M-15 | agency/sub-org isolation; delegated roles/support; branding/domain; billing boundary; auditor marketplace profile/consent/scope/revoke | delegated permission matrix; tenant escape/offboarding/revoke tests; branding cannot alter truth; expiry audit; marketplace limitation |
| P9 / S7 / Gate D | all claimed-live PRD requirements, especially §15, §17–§24 | pentest; security/dependency/log review; load/SLO/RPO/RTO; restore/rollback/outage/replay drills; release manifest; on-call/legal/privacy review | Gate D; non-expired dossiers; 99.5%/p95 targets measured; 100% claimed locales; no unaccepted critical/high truth/security issue; signed release diff |
...
| P1 | WP-13 Market-pack/region readiness | Gate C + region/provider/residency RFC | Indonesia/Asia market-pack baseline dan Gate E candidate |
| P1 | WP-14 Global provider/routing verification | WP-13 + provider RFC per market | provider matrix, routing, sandbox, residency dan transfer proof |
| P1 | WP-15 ISO framework/mapping | Gate E + official ISO source | versioned 93 Annex A, SOC 2↔ISO mapping, gap workflow |
| P1 | WP-16 ISO provider expansion | WP-15 + provider RFC per connector | Azure/GCP/Okta/Vercel/Supabase/Firebase, one-by-one proof records |
| P1 | WP-17 Privacy operations | Gate E + privacy source/residency decision | PII map, cookie scanner, DSAR, DPA, vendor risk, breach workflow |
| P1 | WP-18 AI gateway/questionnaire | stable M-05/M-06 + AI RFC + golden set | M-14 scoped retrieval, citation/refusal, human approval, usage/cost control |
| P2 | WP-19 PCI SAQ assistant | M-05/M-06 + PCI source + human-review workflow | SAQ scope wizard, readiness checklist, approved export; no ASV scanning |
| P2 | WP-20 White-label agency | M-01/M-12/M-13 + delegated-access RFC | agency/sub-organization, delegated roles, branding, billing/residency boundary |
| P2 | WP-21 Auditor marketplace | WP-20 + marketplace contract/consent policy | profile, invite, scope, expiry/revoke, conflict and offboarding controls |
| P0 GA | WP-22 Hardening/GA | all live modules + S7 | Gate D, pentest, load/SLO, restore/incident/legal/on-call proof |
...
| M2R Regional market ready | Gate E lulus | membuka market/region baru tanpa proof residency dan reconciliation |
...
| 3.0 | Menyelaraskan PRD 5.3: global-ready core dan market-pack Indonesia/Asia pada P0/P1B, Phase 3 Global expansion readiness dengan Gate E, serta menggeser ISO, privacy, AI, PCI, white-label, marketplace, dan GA menjadi Phase 4–9 beserta traceability, ownership, exit proof, work package, dan milestone. |